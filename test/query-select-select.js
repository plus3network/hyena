...
describe('Select Query', function () {
  describe('select', function () {
		...
		it('should set only the name select', function () {
			...
			expect(selects.__users__).to.have.property('name').be.ok;
			expect(selects.__users__).to.have.property('email').not.be.ok;
			expect(selects.__users__).to.have.property('causes_sponsors_id').not.be.ok;
			expect(selects.__users__).to.have.property('best_friend_id').not.be.ok;
		});
		...
		it('should only remove email select', function () {
			...
			expect(selects.__users__).to.have.property('name').be.ok;
			expect(selects.__users__).to.have.property('email').not.be.ok;
			expect(selects.__users__).to.have.property('causes_sponsors_id').be.ok;
			expect(selects.__users__).to.have.property('best_friend_id').be.ok;
		});
		...
		it('should set name and email with select and remove', function () {
			...
			var selects = query.data.selects;
			expect(selects.__users__).to.have.property('name').be.ok;
			expect(selects.__users__).to.have.property('email').be.ok;
			expect(selects.__users__).to.have.property('causes_sponsors_id').not.be.ok;
			expect(selects.__users__).to.have.property('best_friend_id').not.be.ok;
		});
		...
		it('should set only email with select and remove', function () {
			...
			var selects = query.data.selects;
			expect(selects.__users__).to.have.property('name').not.be.ok;
			expect(selects.__users__).to.have.property('email').be.ok;
			expect(selects.__users__).to.have.property('causes_sponsors_id').not.be.ok;
			expect(selects.__users__).to.have.property('best_friend_id').not.be.ok;
		});
		...
		it('should set only email with select and remove for aliases', function () {
			var selects = query.data.selects;
			selects.__bestFriend__ = _.cloneDeep(selects.__users__);
